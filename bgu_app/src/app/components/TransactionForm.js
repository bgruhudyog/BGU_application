...
//   const [isOldTouched, setIsOldTouched] = useState(false);
  ...
  const handleTelegramSubmit = () => {
    ...
    const message = `
दिनांक: ${date}\n
रूट: ${localStorage.getItem('dropdown')}\n
दुकान का नाम: ${localStorage.getItem('shop_name')}, ${localStorage.getItem('village_name')}\n
मात्रा: ${quantity} Kg\n
रेट: ₹${rate}\n
    ...
    <Box mt={2}>
      ...
      <Box display="flex" gap={2}>
        ...
        <TextField
          ...
          onChange={(e) => {setOld(e.target.value || '0') }}// Set default to '0' if value is empty
